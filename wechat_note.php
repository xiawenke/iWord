...
echo('<div id="myAlert" class="alert alert-success"><a href="#" class="close" data-dismiss="alert">&times;</a><strong>成功！</strong>错词已保存！</div>');
echo('<meta http-equiv="refresh" content="1;url=./wechat_space.php"> ');
