...
$number=$_GET['number'];
echo('<div id="myAlert" class="alert alert-success"><a href="#" class="close" data-dismiss="alert">&times;</a><strong>已删除</strong>删除后不能再次恢复！(删除若没有立即生效请点<a href="wechat_space.php">这里</a>)。</div>');
include('wechat_space.php');
